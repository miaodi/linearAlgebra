...
protected:
    ...
    void aij_update( IDX _ai, IDX _aj, VAL _av, MKL_INT j_idx, MKL_INT k, MKL_INT base, const double aki, int& list_size, LIST& list );
...
protected:
    ...
    bool numeric_factorize( mkl_sparse_mat const* const A );
    int _lsize{ 0 };
    int _rsize{ 0 };
