...
static std::unique_ptr<std::map<MKL_INT, mkl_wrapper::mkl_sparse_mat>> graph_map_ptr;
...
BENCHMARK_REGISTER_F( MyFixture, UnionFindRank )->RangeMultiplier( 10 )->Range( 1000, 100000 );
...
BENCHMARK_REGISTER_F( MyFixture, UnionFindRem )->RangeMultiplier( 10 )->Range( 1000, 100000 );
...
BENCHMARK_REGISTER_F( MyFixture, ParUnionFindRem )->RangeMultiplier( 10 )->Range( 1000, 100000 );
...
BENCHMARK_REGISTER_F( MyFixture, ParUnionFindRank )->RangeMultiplier( 10 )->Range( 1000, 100000 );
