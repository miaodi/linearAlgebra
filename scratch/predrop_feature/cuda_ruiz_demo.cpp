...
int main(int argc, char* argv[]) {
    ...
    if (opts.norm_type == "maxnorm") {
        ...
        converged = matrix_utils::sparse_cuda::RuizScaleCuda<int32_t, int32_t, double,
                                                               matrix_utils::sparse_cuda::CudaRuizScalingNormType::MaxNorm>(
        ...
        converged = matrix_utils::sparse_cuda::RuizScaleCuda<int32_t, int32_t, double,
                                                               matrix_utils::sparse_cuda::CudaRuizScalingNormType::L2Norm>(
            matrix.rows, matrix.cols, d_ai, d_aj, d_av, d_dr, d_dc, opts.max_iters);
    } else {
    ...
    std::cout << "Column scaling factors range: [" << min_col_scale << ", " << max_col_scale << "]" << std::endl;
