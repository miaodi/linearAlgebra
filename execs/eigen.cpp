...
int main()
{
    ...
    std::cout << "m: " << k.rows() << " , n: " << k.cols() << " , nnz: " << k.nnz() << std::endl;
    k.print();
    ...
    {
        {
            ...
            std::vector<double> eigenvalues( 1, 0 );
            std::vector<double> eigenvectors( 1 * size, 0 );
            utils::Elapse<>::execute( "mkl max eigen: ", [&gv, &eigenvalues, &eigenvectors]()
...

        {
            ...
            std::vector<double> eigenvalues( 1, 0 );
            std::vector<double> eigenvectors( 1 * size, 0 );
            utils::Elapse<>::execute( "mkl min eigen: ", [&gv, &eigenvalues, &eigenvectors]()
                                      { gv.eigen_solve( eigenvalues.data(), eigenvectors.data() ); } );
            for ( auto i : eigenvalues )
            {
                std::cout << 1. / i << std::endl;
    ...
    }
    {
        ...
        std::vector<double> eigenvalues( 1, 0 );
        std::vector<double> eigenvectors( 1 * size, 0 );
        utils::Elapse<>::execute( "power max eigen: ", [&gv, &eigenvalues, &eigenvectors]()
                                  { gv.eigen_solve( eigenvalues.data(), eigenvectors.data() ); } );
        for ( auto i : eigenvalues )
        {
            std::cout << i << std::endl;
        ...
        gv.which( "S" );
        utils::Elapse<>::execute( "power min eigen: ", [&gv, &eigenvalues, &eigenvectors]()
                                  { gv.eigen_solve( eigenvalues.data(), eigenvectors.data() ); } );
        for ( auto i : eigenvalues )
        {
            std::cout << i << std::endl;
