...
extern template cudaError_t ILUBaseNumericFactorizationCachedAsync<int, int, float>(
    int,
    const int*,
    const int*,
    const float*,
...
extern template cudaError_t ILUBaseNumericFactorizationCachedAsync<int, int, double>(
    int,
    const int*,
    const int*,
    const double*,
