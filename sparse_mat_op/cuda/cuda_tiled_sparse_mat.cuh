...
extern template void CSRToTileCOO<int, int, float, false>( int,
                                                           int,
                                                           const int*,
                                                           const int*,
                                                           const float*,
                                                           ...
                                                           cudaStream_t );
extern template void CSRToTileCOO<int, int, float, true>( int,
                                                          int,
                                                          const int*,
                                                          const int*,
                                                          const float*,
                                                          ...
                                                          DeviceTileCOOMatrix<int, int, float>&,
                                                          cudaStream_t );
extern template void CSRToTileCOO<int, int, double, false>( int,
                                                            int,
                                                            const int*,
                                                            const int*,
                                                            const double*,
                                                            ...
                                                            cudaStream_t );
extern template void CSRToTileCOO<int, int, double, true>( int,
                                                           int,
                                                           const int*,
                                                           const int*,
                                                           const double*,
                                                           ...
                                                           DeviceTileCOOMatrix<int, int, double>&,
                                                           cudaStream_t );
extern template void CSRToTileCOO<std::int64_t, int, float, false>( int,
                                                                    int,
                                                                    const std::int64_t*,
                                                                    const int*,
                                                                    const float*,
                                                                    ...
                                                                    cudaStream_t );
extern template void CSRToTileCOO<std::int64_t, int, float, true>( int,
                                                                   int,
                                                                   const std::int64_t*,
                                                                   const int*,
                                                                   const float*,
                                                                   ...
                                                                   DeviceTileCOOMatrix<std::int64_t, int, float>&,
                                                                   cudaStream_t );
extern template void CSRToTileCOO<std::int64_t, int, double, false>( int,
                                                                     int,
                                                                     const std::int64_t*,
                                                                     const int*,
                                                                     const double*,
                                                                     ...
                                                                     cudaStream_t );
extern template void CSRToTileCOO<std::int64_t, int, double, true>( int,
                                                                    int,
                                                                    const std::int64_t*,
                                                                    const int*,
                                                                    const double*,
