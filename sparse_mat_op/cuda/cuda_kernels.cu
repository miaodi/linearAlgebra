...
__global__ void elementwise_multiply_kernel( const double* d_a, const double* d_b, double* d_output, size_t n )
{
...
void elementwiseMultiply( const double* d_a, const double* d_b, double* d_output, size_t n )
{
    ...
    elementwise_multiply_kernel<items_per_thread><<<num_blocks, block_size>>>( d_a, d_b, d_output, n );
