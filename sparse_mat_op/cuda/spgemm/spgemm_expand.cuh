...
extern template bool SpGEMMSymbolicAnalyzeCSR<int, int>( int,
                                                         int,
                                                         const int*,
                                                         const int*,
                                                         int,
...
extern template bool SpGEMMExpandCSR<int, int, float>( int,
                                                       int,
                                                       const int*,
                                                       const int*,
                                                       const float*,
...
extern template bool SpGEMMExpandCSR<int, int, double>( int,
                                                        int,
                                                        const int*,
                                                        const int*,
                                                        const double*,
