...
static void computeEDinv( const VALTYPE* D_diag,
                          const COLTYPE E_rows,
                          const ROWTYPE* E_ai,
                          const COLTYPE* E_aj,
                          VALTYPE* E_av,
                          const int nthreads )
...
void ILUMLevel<CSRMatrixType>::operator()( const COLTYPE size, ROWTYPE const* ai, COLTYPE const* aj, VALTYPE const* av )
{
...
template <matrix_utils::ResizableCSR CSRMatrixType>
void ILUMLevel<CSRMatrixType>::reordering( const COLTYPE size, ROWTYPE const* ai, COLTYPE const* aj, VALTYPE const* av )
{
