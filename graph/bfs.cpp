...
bool BFSKernel_Serial( COLTYPE rows,
                       ROWTYPE const* ai,
                       COLTYPE const* aj,
                       COLTYPE source,
...
template <typename ROWTYPE, typename COLTYPE, bool LASTLEVEL, bool TRACK>
bool BFSKernel_Parallel( COLTYPE rows,
                         ROWTYPE const* ai,
                         COLTYPE const* aj,
                         COLTYPE source,
                         COLTYPE shortCutWidth,
...
template bool BFSFunc<int, int, true, true>( int rows,
                                             int const* ai,
                                             int const* aj,
                                             int source,
                                             int shortCut,
...
template bool BFSFunc<int, int, false, true>( int rows,
                                              int const* ai,
                                              int const* aj,
                                              int source,
                                              int shortCut,
...
template bool BFSFunc<int, int, true, false>( int rows,
                                              int const* ai,
                                              int const* aj,
                                              int source,
                                              int shortCut,
...
template bool BFSFunc<int, int, false, false>( int rows,
                                               int const* ai,
                                               int const* aj,
                                               int source,
                                               int shortCut,
...
template bool BFSFunc<int64_t, int64_t, true, true>( int64_t rows,
                                                     int64_t const* ai,
                                                     int64_t const* aj,
                                                     int64_t source,
                                                     int64_t shortCut,
...
template bool BFSFunc<int64_t, int64_t, false, true>( int64_t rows,
                                                      int64_t const* ai,
                                                      int64_t const* aj,
                                                      int64_t source,
                                                      int64_t shortCut,
...
template bool BFSFunc<int64_t, int64_t, true, false>( int64_t rows,
                                                      int64_t const* ai,
                                                      int64_t const* aj,
                                                      int64_t source,
                                                      int64_t shortCut,
...
template bool BFSFunc<int64_t, int64_t, false, false>( int64_t rows,
                                                       int64_t const* ai,
                                                       int64_t const* aj,
                                                       int64_t source,
                                                       int64_t shortCut,
