...
TEST_P( CudaSpMM, SpMMStruct_AA )
{
    ...
    SerialTranspose<int, int, double>( n, n, ai.data(), aj.data(), av.data(), ai_csc.data(),
                                       aj_csc.data(), nullptr );
    ...
    ASSERT_TRUE( ( SpMMStruct<int, int>( n, d_ai_csc.data(), d_aj_csc.data(), d_ai.data(),
                                         d_aj.data(), 0, d_packed_coo ) ) );
