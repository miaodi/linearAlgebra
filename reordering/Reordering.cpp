...
#ifdef USE_METIS_LIB
template <typename ROWTYPE, typename COLTYPE>
int MetisND(const COLTYPE nrows, const COLTYPE ncols, const ROWTYPE* xadj, const COLTYPE* adjncy,
...
#ifdef USE_METIS_LIB
template int MetisND<int32_t, int32_t>(const int32_t, const int32_t, const int32_t*, const int32_t*,
                                       int32_t*, int32_t*, const MetisNDOptions&);
template int MetisND<int64_t, int64_t>(const int64_t, const int64_t, const int64_t*, const int64_t*,
                                       int64_t*, int64_t*, const MetisNDOptions&);
template int MetisND<int64_t, int32_t>(const int32_t, const int32_t, const int64_t*, const int32_t*,
                                       int32_t*, int32_t*, const MetisNDOptions&);
#endif
} // namespace reordering