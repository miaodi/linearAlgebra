...
void setDifferenceInPlace( QuotientGraph::NodePtrSet& target, const QuotientGraph::NodePtrSet& subtracted )
{
...
int setDifferenceSum( const QuotientGraph::NodePtrSet& target, const QuotientGraph::NodePtrSet& subtracted )
{
    auto it_t = target.begin();
    auto it_s = subtracted.begin();
    int k = 0;
...
void QuotientGraph::Node::approxDegreeUpdate( QuotientGraph& graph, NodePtrSet& super_neighbors, int active_matrix_size )
{
    // clean previous shit
    for ( NodePtr n : super_neighbors )
    {
...
void QuotientGraph::Node::externalDegreeUpdate( QuotientGraph& graph, NodePtrSet& super_neighbors )
{
    for ( NodePtr n : super_neighbors )
    {
